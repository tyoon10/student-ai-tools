...
1. **Status**: active, ended, institutional, none or unverified.
2. **Offered tier and pricing**: original price against student price.
3. **Included features**: what the student tier actually unlocks.
4. **Effective length**: duration, renewal behaviour, re-verification cadence.
5. **Verification method**: SheerID, .edu email, GitHub Education and so on.
6. **Regions**: where the offer is claimable, when the vendor restricts it.
7. **Caveats**: the things that bite people.
8. **Referral programme**: whether one exists and who benefits. Recorded as a fact about the tool, not as a prompt to share a link.
...
Scope: tools with a validated or formerly validated student offer. Referral-only tools sit on their own axis further down and never compete for a slot here.

### Tier S: Ubiquitous, mainstream AI tools
1. **Notion**: The single best note and knowledge tool for grad school. Free Plus plan for a one-member workspace if you have an eligible school email. I run Notion as an oper
...
- Category: Meeting notes | Tier: B
- Original pricing: Granola Business is a paid tier.
- Student pricing: 12 months of Granola Business free.
- Included features: Background capture with no meeting bot, transcript plus structured searchable summaries, mobile support.
...
- Category: Developer tools | Tier: S
...
- Category: AI code editor | Tier: C
...
- Category: AI search | Tier: S
- Original pricing: Pro at 20 USD per month.
- Student pricing: Education Pro at 10 USD per month, a 50 percent discount.
...
- Category: Design and creative | Tier: S
- Original pricing: 69.99 USD per month for Creative Cloud Pro at regular monthly pricing.
- Student pricing: About 19.99 USD per month for the first year on the annual plan billed monthly, rising to about 39.99 USD per month afterwards. Roughly 71 percent off in year one in the US market.
- Included features: 20-plus Creative Cloud apps plus Firefly generative AI features.
- Effective length: Promotional pricing for the first year, then a materially higher renewal rate.
...
- Category: Transcription | Tier: B
- Original pricing: Otter Pro standard pricing.
...
- Original pricing: Premium paid tier.
- Student pricing: 40 percent off for students and faculty. Clinicians get 25 percent.
...
- Category: AI coding | Tier: S
- Original pricing: No standing global ChatGPT Plus student discount.
- Student pricing: 100 USD in ChatGPT credits, equal to 2,500 credits, for use in Codex.
- Included features: Codex usage inside ChatGPT. Code generation, multi-file edits, IDE and CLI tasks.
- Effective length: Credits expire 12 months after the grant date. Unused credits are lost.
...
- Category: Writing | Tier: A
- Original pricing: Grammarly Pro regular pricing.
- Student pricing: 50 percent off through the SheerID campaign listing.
...
- Category: Writing | Tier: B
- Original pricing: QuillBot Premium standard pricing.
- Student pricing: Up to 25 percent off. Tiered by billing cycle, roughly 10 percent monthly, 15 percent quarterly or semi-annual, and 25 percent annual.
- Included features: QuillBot Premium features.
- Effective length: Campaign-based.
- Verification: Student Beans or UNiDAYS.
- Caveat: The student discount does not stack with other promo codes at checkout.
- Referral programme: **affiliate-only**. A PartnerStack affiliate programme paying commission. No two-sided peer benefit.
- Official sources:
  - https://quillbot.com/upgrade/studentbeans
...
- Student pricing: Previously one year of Cursor Pro free. No longer available to new applicants.
- Included features: n/a
- Effective length: If you already redeemed it you keep your current rate until the plan expires, after which it reverts to the standard 20 USD per month Pro rate.
- Verification: n/a
- Caveat: Replacement routes, per Cursor's own docs. Undergraduates can claim credits and discounts at on-campus and online events starting this autumn. Graduate students, researchers and educators can request credits through a form.
- Referral programme: **none**. A referral feature exists but is limited to a small invited beta.
- Official sources:
...
- Status: active
- Student offer: 100 USD of Azure credit to use within 12 months, with no credit card required.
- Also included: Free monthly amounts of 20-plus popular services for 12 months, plus 65-plus always-free services.
- Effective length: 12-month credit window, renewable annually while enrolled.
- Verification: School email. Available only to full-time university students.
- Referral programme: **none**. Terms state one subscription per eligible customer, non-transferable, and not combinable with any other offer, which rules out stacking.
- Sources:
...
- Status: active
- Student offer: 200 Google Skills credits for hands-on labs, skill badges and courses on Google Cloud Skills Boost. This is learning credit, not deployment credit.
- Also included: Separate faculty-led programmes can grant GCP billing credit for coursework. The general 300 USD new-account trial is not student-specific.
- Effective length: Credits expire one year after issuance. Requests can take up to two weeks to process.
- Verification: Faculty, students and IT admins at accredited higher-education institutions in eligible countries.
- Referral programme: **none**. No student-side referral. Faculty Research Credits has a referrer benefit and a general affiliate programme exists, but neither applies to students.
- Sources:
  - https://cloud.google.com/edu/students
  - https://cloud.google.com/affiliate-program
- Last checked: 2026-08-18 | Confidence: medium
...
## Excluded: institutional only, or no student offer
...
- Status: institutional
- Reason: Canva for Education is the eligibility-based K-12 offer. Higher-education access runs through Canva Campus, which the institution buys and manages. There is no individual higher-ed claim, so without a Campus licence a university student is on Canva Free.
- Detail: One adjacent route exists. Canva opened Campus Canvassadors, a student ambassador programme for US university students, with its first cohort running August to December 2026. Applications are prioritised for students already at Canva for Campus schools, so it rewards existing access rather than creating it.
- Check path: Ask whether your school has procured Canva Campus.
- Sources:
  - https://www.canva.com/for-campus/
  - https://www.canva.com/help/about-canva-for-campus/
  - https://www.canva.com/help/about-canva-for-education/
- Last checked: 2026-08-18 | Confidence: high

### Midjourney

- Status: none
- Reason: No individual student programme in 2026. The 20 percent saving on annual billing is available to everyone and is not a student discount.
- Detail: Midjourney's educational-use policy is explicit that each student needs their own account and their own subscription. There are no shared accounts, no group plans and no way for a school to manage student accounts centrally, though schools can reimburse students directly.
- Sources:
...
- **SciSpace** (opened 2026-05-03). Official student policy could not be captured from blocked pricing endpoints. Open for more than three months with no confirmation. Removed from the tier ranking and excluded from the public list. Will only return if the vendor publishes terms or confirms them in writing.
...
- **Mistral Le Chat**: No referral programme documented.
